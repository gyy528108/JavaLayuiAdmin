...
public class InitTableController {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/lowi?serverTimezone=GMT%2B8&amp");
...
//         strategy.setSuperEntityClass("com.lowi.admin.entity");
